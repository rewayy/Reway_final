  ...
  <div>
    ...
    <Link to="mailto:reway.ewm@gmail.com" className="mb-4">
      ...
      <div className='w-full h-full absolute -top-8 mt-4 md:mt-2 md:gap-4 gap-6 text-white  flex flex-col  justify-center items-center '>
        ...
        {/* Button */}
        <Link to={'/services'} className=' md:text-xl text-center  border font-mont border-white  px-2 md:px-0  hover:bg-white/20  w-[150px] md:w-[175px] h-[45px] shadow-md  py-1 rounded-full cursor-pointer' > know more</Link>
      </div>
    </div>
  );
};
