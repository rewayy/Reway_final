      ...
      <div className="w-full md:w-1/2 dark:shadow-lg md:mx-20 my-14 -mb-2 md:my-20">
        <div className='mx-4  md:mx-20'>
          <div className="text-center md:text-start">
            <h1 className="inline-block text-green-600 bg-green-200 shadow-md bg-opacity-75 md:p-3 md:my-8"> OUR PAST RESULTS </h1>
          </div>
          <div className='my-12 w-full p-1  rounded-md  flex flex-col items-center justify-center md:block'>
            <h1 className='text-green-600  text-4xl inline-block md:text-7xl'>21 </h1>
            <span className='text-green-600 font-semibold text-xl md:text-3xl'>recyclers</span>
          ...
          <div className='my-12   p-1 flex flex-col items-center justify-center md:block'>
            <h1 className='text-green-600 text-4xl inline-block md:text-7xl'>8.64 </h1>
            <span className='text-green-600 text-xl font-semibold md:text-3xl'>ton</span>
          ...
          <div className='my-12  p-1 flex flex-col items-center justify-center md:block'>
            <h1 className='text-green-600 inline-block text-4xl md:text-7xl'>6000+</h1>
            <span className='text-green-600 font-semibold text-xl md:text-3xl'>kg</span>
