...
export const Map = () => {
  return (
    <div className='flex flex-col mb-8 md:mb-0  md:mt-20 md:flex-row mx-12'>
      ...
      <div className="w-full md:w-1/2 md:shadow-lg md:mx-20  md:-mb-2 md:my-20">
        <div className='mx-4 flex flex-col items-center justify-center md:block  md:mx-20'>
          <div className="text-center  md:text-start">
            <h1 className="inline-block md:text-4xl text-[#3A9F19] bg-[#E6F9EF]  bg-opacity-75 md:p-3 md:my-8"> OUR PAST RESULTS </h1>
          </div>
          <div className=' border border-[#3A9F19] md:border-none  md:shadow-[#3A9F19] shadow-md w-[80vw]  md:w-[30vw] md:px-4 rounded-md'>
