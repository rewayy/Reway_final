...
export const Thumbnail = () => {
  return (
    <div className='w-full h-full  py-10 -mb-10 md:mb-0 lg:mt-4 relative '>
        ...
        <div className=' absolute -top-[14px] lg:-top-[34px]  w-full  flex justify-center items-center  '>
            ...
            <div className='flex flex-col md:flex-row justify-center  p-4 py-0 md:py-8 sm:py-0 gap-4 md:gap-24 items-center'>
              ...
              {/* Youtube-video here */}
              <div className='sm:w-[50vw] mt-4 md:mt-0  sm:h-[22vw] w-[70vw] h-[39vw] md:w-[50vw] md:h-[22vw] lg:w-[40vw] lg:h-[20vw] '>
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/9vELvnN-9sU?si=V1gN3XNL6lqaLrYJ" title="YouTube video player" frameborder="0"
