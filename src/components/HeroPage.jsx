        ...
        {/* Navbar */}
            <div className='w-full h-[80px] absolute top-0 left-0 z-10  '>
                <div className='max-w-[1183px] m-auto  text-white font-thin h-full flex items-center justify-between'>
                    ...
                    <button className='rounded-full px-4 text-[#087D39] text-sm shadow-md hover:scale-105 duration-150 font-semibold py-2  tracking-wider bg-white'>E-marketplace</button>
                </div>
            </div>
